(module
  ...
  (import "env" "setTempRet0" (func (;2;) (type 2)))
  ...
  (func (;26;) (type 0) (param i32) (result i32)
    ...
    local.get 1)
  (func (;27;) (type 8) (param i32 i32 i64 i32) (result i64)
    local.get 1
    local.get 2
    local.get 3
    local.get 0
    call_indirect (type 3))
  (func (;28;) (type 6) (param i32 i32 i32 i32 i32) (result i32)
    (local i64)
    local.get 0
    local.get 1
    local.get 2
    ...
    local.get 5
    i32.wrap_i64)
  (func (;29;) (type 9) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.wrap_i64
    local.get 1
